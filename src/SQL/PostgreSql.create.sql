...
CREATE INDEX Indexc5c04960c86fe49a08a41d58b4c8ff51ab87d446 on Логистика (СлужбаДоставки); 
 ...
 ALTER TABLE РегистрПосылок ADD CONSTRAINT FK960b02c37ca616194011a0d131f2820b6079703a FOREIGN KEY (Посылка) REFERENCES Посылка; 
CREATE INDEX Index960b02c37ca616194011a0d131f2820b6079703a on РегистрПосылок (Посылка); 

 ALTER TABLE РегистрПосылок ADD CONSTRAINT FKf53572c63a58d2c5fa433d00c8d8a5f247ad647f FOREIGN KEY (Хранение) REFERENCES Хранение; 
CREATE INDEX Indexf53572c63a58d2c5fa433d00c8d8a5f247ad647f on РегистрПосылок (Хранение); 
