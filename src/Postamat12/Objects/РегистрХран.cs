...
namespace IIS.Postamat12
{
    ...
    public class РегистрХран : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat12.Постамат fПостамат;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Postamat12.Постамат.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Постамат"})]
        public virtual IIS.Postamat12.Постамат Постамат
        {
            get
            {
                ...
                IIS.Postamat12.Постамат result = this.fПостамат;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистрХранE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистрХранE", typeof(IIS.Postamat12.РегистрХран));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРегистрХран : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Postamat12.DetailArrayOfРегистрХран members)

        // *** End programmer edit section *** (IIS.Postamat12.DetailArrayOfРегистрХран members)
        ...
        /// </summary>
        public DetailArrayOfРегистрХран(IIS.Postamat12.Постамат fПостамат) : 
                base(typeof(РегистрХран), ((ICSSoft.STORMNET.DataObject)(fПостамат)))
        {
        }
        
        public IIS.Postamat12.РегистрХран this[int index]
        {
            get
            {
                return ((IIS.Postamat12.РегистрХран)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Postamat12.РегистрХран dataobject)
        {
