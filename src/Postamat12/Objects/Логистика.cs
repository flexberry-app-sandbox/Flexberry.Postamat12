...
namespace IIS.Postamat12
{
    ...
    public class Логистика : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat12.Состояние fСостояние;
        ...
        public virtual IIS.Postamat12.Состояние Состояние
        {
            get
            {
                ...
                IIS.Postamat12.Состояние result = this.fСостояние;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЛогистикаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаE", typeof(IIS.Postamat12.Логистика));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЛогистикаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаL", typeof(IIS.Postamat12.Логистика));
                }
            }
        }
    }
