...
namespace IIS.Postamat12
{
    ...
    public class Постамат : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat12.Статусы fСтатус;
        
        private IIS.Postamat12.СлужбаДоставки fСлужбаДоставки;
        
        private IIS.Postamat12.DetailArrayOfРегистрХран fРегистрХран;
        ...
        public virtual IIS.Postamat12.Статусы Статус
        {
            get
            {
                ...
                IIS.Postamat12.Статусы result = this.fСтатус;
        ...
        [PropertyStorage(new string[] {
                "СлужбаДоставки"})]
        [NotNull()]
        public virtual IIS.Postamat12.СлужбаДоставки СлужбаДоставки
        {
            get
            {
                ...
                IIS.Postamat12.СлужбаДоставки result = this.fСлужбаДоставки;
        ...
        public virtual IIS.Postamat12.DetailArrayOfРегистрХран РегистрХран
        {
            get
            {
                ...
                {
                    this.fРегистрХран = new IIS.Postamat12.DetailArrayOfРегистрХран(this);
                }
                IIS.Postamat12.DetailArrayOfРегистрХран result = this.fРегистрХран;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПостаматE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматE", typeof(IIS.Postamat12.Постамат));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПостаматL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматL", typeof(IIS.Postamat12.Постамат));
                }
            }
        }
    }
