    ...
    public class Ячейка : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЯчейкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЯчейкаE", typeof(IIS.Postamat12.Ячейка));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЯчейкаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЯчейкаL", typeof(IIS.Postamat12.Ячейка));
                }
            }
        }
    }
